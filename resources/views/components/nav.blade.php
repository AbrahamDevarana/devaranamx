        ...
        <div class="relative">
            <div class="md:w-10/12 m-auto py-3 flex">
                <ul class="list-none grid grid-cols-6 grid-flow-col text-center font-playfair m-auto w-full relative">
                    <li class="h-7 w-7 absolute -left-9 bottom-[22%]">
                        <a href="/" title="Home" {{ $attributes['hidden'] }} class="">
    ...
    <nav class="md:hidden hidden mobile-menu fixed w-full bg-devarana-blue z-50 transition-all duration-300 ease-in-out opacity-0 shadow-lg h-screen overflow-hidden">
        <div class="flex h-full py-10">
            <ul class="text-devarana-pearl px-3 w-full my-10 text-center font-playfair">
                <li class="m-auto py-4 "> <a href="{{ route('/') }}" class="growLine relative after:bg-devarana-pearl text-3xl">  Home  </a> </li>
                <li class="m-auto py-4 "> <a href="{{ route('quienes-somos') }}" class="growLine relative after:bg-devarana-pearl text-3xl">  Quiénes somos  </a> </li>
                <li class="m-auto py-4 "> <a href="{{ route('nuestro-equipo') }}" class="growLine relative after:bg-devarana-pearl text-3xl">  Nuestro equipo  </a> </li>
                <li class="m-auto py-4 "> <a href="{{ route('nuestra-trayectoria') }}" class="growLine relative after:bg-devarana-pearl text-3xl">  Nuestra trayectoria  </a> </li>
                <li class="m-auto py-4 "> <a href="{{ route('contacto') }}" class="growLine relative after:bg-devarana-pearl text-3xl">  Contacto  </a> </li>
            </ul>
        </div>
    </nav>
    <div class="relative">
        <div class="md:hidden fixed z-[10000] w-full bg-devarana-blue mb-5 ">
            <div class="grid grid-cols-12">
                <div class="col-span-10 flex col-start-2">
                    <a class="text-center m-auto hover:opacity-30" href="/"><img src="{{ asset("img/logos/LogotipoDevarana_blanco.png") }}" alt="Devarana Logotipo" class="w-[150px] py-2" id="devaranaLogoBlanco"></a>
                </div>
                <div class="col-span-1 py-2">        
                    <button class="outline-none mobile-menu-button ml-auto active:rotate-270 active:scale-50 focus:outline-0 transition-all ease-in-out duration-500 hover:opacity-60" id="btnResponsiveMenu">
                        <img id="imgOpen" src="{{ asset('img/icons/burger.svg') }}" alt="burger" height="30" width="30" class="text-gray-400">
                        <img id="imgClose" src="{{ asset('img/icons/cross.svg') }}" alt="burger" height="30" width="30" class="text-gray-400 hidden">
                    </button>
                </div>
            </div>
        </div>
